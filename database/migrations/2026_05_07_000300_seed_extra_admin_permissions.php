...
return new class extends Migration
{
    ...
    {
        return [
            ['name' => 'Manage checkout guard settings', 'slug' => 'settings.checkout-guard.manage', 'group' => 'settings', 'description' => 'Manage checkout cooldown and duplicate-order guard settings.'],
            ['name' => 'Manage mail setup', 'slug' => 'settings.mail.manage', 'group' => 'settings', 'description' => 'Manage SMTP, Gmail, webmail, and test email settings.'],
        ];
    }
