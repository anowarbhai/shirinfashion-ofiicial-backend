...
class OrderController extends Controller
{
    ...
    protected function validateOrderPayload(Request $request): array
    {
        $payload = $request->validate([
            ...
            'meta_campaign_facebook_pixel_ids' => ['nullable', 'array', 'max:20'],
            'meta_campaign_facebook_pixel_ids.*' => ['string', 'max:80', 'regex:/^[A-Za-z0-9_-]+$/', 'distinct'],
    ...
    protected function fillOrderFromPreparedPayload(
        ...
        $order->fill([
            ...
            'meta_campaign_facebook_pixel_ids' => $payload['meta_campaign_facebook_pixel_ids'] ?? null,
