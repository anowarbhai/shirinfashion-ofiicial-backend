...
class EnsureAdminPermission
{
    ...
    private function permissionFor(Request $request): string|array|null
    {
        ...
        return match (true) {
            ...
            str_starts_with($adminPath, 'products') && $isRead => 'products.view',
            str_starts_with($adminPath, 'products') && $method === 'POST' => ['products.create', 'products.manage'],
            str_starts_with($adminPath, 'products') && in_array($method, ['PATCH', 'PUT'], true) => ['products.edit', 'products.manage'],
            str_starts_with($adminPath, 'products') && $method === 'DELETE' => ['products.delete', 'products.manage'],
            str_starts_with($adminPath, 'products') => 'products.manage',
            ...
            str_starts_with($adminPath, 'blog') && $isRead => ['blog.view', 'blog.manage'],
            str_starts_with($adminPath, 'blog') && $method === 'POST' => ['blog.create', 'blog.manage'],
            str_starts_with($adminPath, 'blog') && in_array($method, ['PATCH', 'PUT'], true) => ['blog.edit', 'blog.manage'],
            str_starts_with($adminPath, 'blog') && $method === 'DELETE' => ['blog.delete', 'blog.manage'],
            str_starts_with($adminPath, 'blog') => ['blog.manage'],
            ...
            str_starts_with($adminPath, 'settings/payment-gateway') => 'settings.general.manage',
            str_starts_with($adminPath, 'settings/mobile-push') => 'settings.general.manage',
