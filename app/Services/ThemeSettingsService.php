    ...
    public function defaults(): array
    {
        return [
            ...
            'header' => [
                ...
                'announcement_bg_color' => '#ff2b61',
                'announcement_text_color' => '#ffffff',
                'show_hot_offer_bar' => true,
                'hot_offer_badge' => 'HOT OFFER',
                'hot_offer_text' => 'Limited Stock Offer: Get up to BDT 200 off + Free Gift on bundle purchases!',
                'hot_offer_expires_at' => '',
                'hot_offer_bg_color' => '#0a0e1a',
                'hot_offer_text_color' => '#ffffff',
